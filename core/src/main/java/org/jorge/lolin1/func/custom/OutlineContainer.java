...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(LoLin1Utils.dpToPx(getResources(), 2));
        mOutlinePaint.setColor(getResources().getColor(R.color.theme_dark_blue));
        mOutlinePaint.setStyle(Style.STROKE);

        int padding = LoLin1Utils.dpToPx(getResources(), 10);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int offset = LoLin1Utils.dpToPx(getResources(), 5);
