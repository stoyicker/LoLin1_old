 ...
 * <p/>
 * Created by Jorge Antonio Diaz-Benito Soriano on 22/01/14.
 */
public class TranslatableHeaderTransformer extends HeaderTransformer {
    ...
    public TranslatableHeaderTransformer() {
    ...
    public void onViewCreated(Activity activity, View headerView) {
        ...
        mHeaderProgressBar = (SmoothProgressBar) headerView
                .findViewById(uk.co.senab.actionbarpulltorefresh.library.R.id.ptr_progress);
        mHeaderTextView = (TextView) headerView
                .findViewById(uk.co.senab.actionbarpulltorefresh.library.R.id.ptr_text);
        mContentLayout = (ViewGroup) headerView
                .findViewById(uk.co.senab.actionbarpulltorefresh.library.R.id.ptr_content);

        // Default Labels to display
        mPullRefreshLabel = activity.getString(
                uk.co.senab.actionbarpulltorefresh.library.R.string.pull_to_refresh_pull_label);
        mRefreshingLabel = activity.getString(
                uk.co.senab.actionbarpulltorefresh.library.R.string.pull_to_refresh_refreshing_label);
        mReleaseLabel = activity.getString(
                uk.co.senab.actionbarpulltorefresh.library.R.string.pull_to_refresh_release_label);
        ...
        mProgressDrawableColor = activity.getResources()
                .getColor(
                        uk.co.senab.actionbarpulltorefresh.library.R.color.default_progress_bar_color);
    ...
    private void setupViewsFromStyles(Activity activity, View headerView) {
        final TypedArray styleAttrs = obtainStyledAttrsFromThemeAttr(activity,
                ...
                uk.co.senab.actionbarpulltorefresh.library.R.styleable.PullToRefreshHeader);
        ...
        Drawable bg = styleAttrs.hasValue(
        ...
        final int titleTextStyle = styleAttrs
                .getResourceId(
                        uk.co.senab.actionbarpulltorefresh.library.R.styleable.PullToRefreshHeader_ptrHeaderTitleTextAppearance,
        ...
        if (styleAttrs.hasValue(
                uk.co.senab.actionbarpulltorefresh.library.R.styleable.PullToRefreshHeader_ptrProgressBarColor)) {
        ...
        mProgressBarStyle = styleAttrs.getInt(
                uk.co.senab.actionbarpulltorefresh.library.R.styleable.PullToRefreshHeader_ptrProgressBarStyle,
                PROGRESS_BAR_STYLE_OUTSIDE);

        if (styleAttrs.hasValue(
                uk.co.senab.actionbarpulltorefresh.library.R.styleable.PullToRefreshHeader_ptrProgressBarHeight)) {
            mProgressBarHeight = styleAttrs.getDimensionPixelSize(
                    uk.co.senab.actionbarpulltorefresh.library.R.styleable.PullToRefreshHeader_ptrProgressBarHeight,
                    mProgressBarHeight);
        }

        mPullRefreshLabel = abContext.getString(org.jorge.lolin1.R.string.ptr_pull_text);
        mRefreshingLabel = abContext.getString(org.jorge.lolin1.R.string.ptr_refreshing_text);
        mReleaseLabel = abContext.getString(org.jorge.lolin1.R.string.ptr_released_text);
        ...
        switch (mProgressBarStyle) {
            case PROGRESS_BAR_STYLE_INSIDE:
                lp.addRule(RelativeLayout.ALIGN_BOTTOM,
                        uk.co.senab.actionbarpulltorefresh.library.R.id.ptr_content);
                break;
        ...
        if (mHeaderProgressBar != null) {
            final int strokeWidth = mHeaderProgressBar.getResources()
                    .getDimensionPixelSize(
                            uk.co.senab.actionbarpulltorefresh.library.R.dimen.ptr_progress_bar_stroke_width);
