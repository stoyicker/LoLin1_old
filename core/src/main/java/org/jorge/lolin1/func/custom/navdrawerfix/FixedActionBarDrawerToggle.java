package org.jorge.lolin1.func.custom.navdrawerfix;
 ...
 * {@link org.jorge.lolin1.func.custom.navdrawerfix.FixedDrawerLayout} and the framework <code>ActionBar</code> to implement the recommended
 ...
 * {@link org.jorge.lolin1.func.custom.navdrawerfix.FixedDrawerLayout.DrawerListener}, or if you are already providing your own listener,
 * call through to each of the listener methods from your own.</p>
 */
public class FixedActionBarDrawerToggle implements FixedDrawerLayout.DrawerListener {

    /**
     * Allows an implementing Activity to return an {@link FixedActionBarDrawerToggle.Delegate} to use
    ...
    private static class ActionBarDrawerToggleImplHC implements ActionBarDrawerToggleImpl {
        @Override
        public Drawable getThemeUpIndicator(Activity activity) {
            return FixedActionBarDrawerToggleHoneycomb.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, Activity activity,
                                              Drawable themeImage, int contentDescRes) {
            return FixedActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(info, activity,
                    themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
            return FixedActionBarDrawerToggleHoneycomb.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }
    ...
    private final FixedDrawerLayout mDrawerLayout;
     ...
     * <p/>
     * <p>The given {@link Activity} will be linked to the specified {@link org.jorge.lolin1.func.custom.navdrawerfix.FixedDrawerLayout}.
     ...
     *                                  for accessibility
     */
    public FixedActionBarDrawerToggle(Activity activity, FixedDrawerLayout drawerLayout,
    ...
    /**
     * {@link org.jorge.lolin1.func.custom.navdrawerfix.FixedDrawerLayout.DrawerListener} callback method. If you do not use your
